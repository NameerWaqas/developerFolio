...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Backend development using both SQL & noSQL databases for seamless user experience"
    ),
    emoji("⚡ Deploy the web/server on cloud via AWS EC2 or Azure VMs"),
  ],
...
https://fontawesome.com/icons?d=gallery */
  ...
  softwareSkills: [
    ...
    // Non relative skills are comment @nameer
    {
      skillName: "sass",
...
const workExperiences = {
  // viewExperiences has been set to False @ nameer
...
const openSource = {
  ...
  githubUserName: "nameerwaqas", // Change to your github username to view your profile in Contact Section.
...
const bigProjects = {
  title: "Projects",
  subtitle: "SOME PEOJECTS THAT I HAVE WORKED ON.",
  projects: [
    {
...
const contactInfo = {
  ...
  number: "+92-3122741771",
  email_address: "nameerwaqas321@gmail.com",
};
